...
set project_name [env_or_default "HLS_PROJECT" "layer0_hls_prj"]
set solution_name [env_or_default "HLS_SOLUTION" "sol1"]
set top_name [env_or_default "HLS_TOP" "conv_ico_layer0"]
...
add_files ico_conv_layer0.cpp
add_files ico_conv_layer0.hpp
add_files -tb test_ico_conv.cpp
