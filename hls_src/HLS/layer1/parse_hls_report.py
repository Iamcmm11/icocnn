...
def main():
    ...
    parser.add_argument("--project", default="layer1_hls_prj")
    parser.add_argument("--solution", default="sol1")
    parser.add_argument("--top", default="conv_ico_layer1")
    ...
    write_summary_md(summary_path, meta=meta, summary=summary, report_paths=copied)

    latest_path = reports_root / "layer1_latest_summary.md"
    shutil.copy2(summary_path, latest_path)

    history_csv = reports_root / "summary_history.csv"
    append_history(history_csv, meta=meta, summary=summary, snapshot_dir=snapshot_dir)
