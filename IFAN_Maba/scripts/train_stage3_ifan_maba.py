...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run IFAN_Maba stage-3 training, validation, and baseline comparison.")
    parser.add_argument("--config", default="IFAN_Maba/configs/stage3_maba_default.toml")
    ...
    parser.add_argument("--temporal-backend", choices=("conv1d", "maba"), default=None, help="Choose whether the stage-3 temporal module uses the original Conv1d blocks or the MABA replacement.")
...
def main() -> None:
    ...
    if args.temporal_backend is not None:
        config.temporal_backend = str(args.temporal_backend)
    if args.lms_plain:
