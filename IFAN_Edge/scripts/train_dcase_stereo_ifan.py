...
from ifan_edge.training.dcase_stereo import DcaseStereoTrainer, DcaseStereoTrainingConfig


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train a DCASE stereo folded-azimuth IFAN branch.")
    parser.add_argument("--config", default="IFAN_Edge/configs/dcase_stereo_folded_azimuth_c8_r2_maba_pre_readout.toml")
...
def main() -> None:
    ...
    config = DcaseStereoTrainingConfig.from_toml(args.config)
    if args.cpu:
        config.device = "cpu"
