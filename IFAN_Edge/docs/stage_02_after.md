...
“`PHAT + LMS` 主线下已进入主干重构与参数验证阶段，工程验证已完成，尚未进入正式训练验收。”
...
- 当前参数量验证基线固定为：
  - 原始 `IcoTempCNN(r=2, C=32) = 290,017`，约 `0.29M`
  - 当前 `IFANModel(C=16, residual on) = 76,433`
  - 当前 `IFANModel(C=16, residual off) = 33,297`
